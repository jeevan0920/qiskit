...
";
    ...
    fn test_cphase() {
        ...
        // target qubit.  See issue #15849, task 7.
        let qubits = vec![
            ShareableQubit::new_anonymous(),
            ShareableQubit::new_anonymous(),
        ];
...
";
    ...
    fn test_cphase_reversed_qubit_order() {
        // CPhase where the control qubit index is higher than the target.
        // The label should still appear on the connecting wire between them.
        let qubits = vec![
            ShareableQubit::new_anonymous(),
            ShareableQubit::new_anonymous(),
        ];
...
";
    ...
    #[test]
    fn test_cphase_mixed_circuit() {
        // A 4-qubit circuit mixing CPhase gates (adjacent, non-adjacent, different
        // params) with other standard gates to verify CPhase rendering integrates
        // correctly in a complex layout.
        let qubits = vec![
            ShareableQubit::new_anonymous(),
            ShareableQubit::new_anonymous(),
            ShareableQubit::new_anonymous(),
        ...
        // CPhase(0.5) on adjacent q_0, q_1
        circuit
            .push_standard_gate(
                StandardGate::CPhase,
                &[Param::Float(0.5)],
        ...
        // CPhase(1.2) spanning q_1..q_3 (non-adjacent, q_2 in between)
        circuit
            .push_standard_gate(
                StandardGate::CPhase,
                &[Param::Float(1.2)],
